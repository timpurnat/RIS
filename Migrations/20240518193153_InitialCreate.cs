        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    znamkaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImeFerme = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    znamkaID1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Znamke", x => x.znamkaID);
                    table.ForeignKey(
                        name: "FK_Znamke_Znamke_znamkaID1",
                        column: x => x.znamkaID1,
                        principalTable: "Znamke",
                        principalColumn: "znamkaID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    znamkaID = table.Column<int>(type: "int", nullable: true),
                    ZvrstID = table.Column<int>(type: "int", nullable: true),
                    KategorijaID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Izdelki", x => x.IzdelekId);
                    table.ForeignKey(
                        name: "FK_Izdelki_Kategorija_KategorijaID",
                        column: x => x.KategorijaID,
                        principalTable: "Kategorija",
                        principalColumn: "KategorijaID");
                    table.ForeignKey(
                        name: "FK_Izdelki_Znamke_znamkaID",
                        column: x => x.znamkaID,
                        principalTable: "Znamke",
                        principalColumn: "znamkaID");
                    table.ForeignKey(
                        name: "FK_Izdelki_Zvrsti_ZvrstID",
                        column: x => x.ZvrstID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rezervacije_Izdelki_IzdelekId",
                        column: x => x.IzdelekId,
                        principalTable: "Izdelki",
                        principalColumn: "IzdelekId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Izdelki_KategorijaID",
                table: "Izdelki",
                column: "KategorijaID");

            migrationBuilder.CreateIndex(
                name: "IX_Izdelki_znamkaID",
                table: "Izdelki",
                column: "znamkaID");

            migrationBuilder.CreateIndex(
                name: "IX_Izdelki_ZvrstID",
                table: "Izdelki",
                column: "ZvrstID");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervacije_IzdelekId",
                table: "Rezervacije",
                column: "IzdelekId",
                unique: true);
